export default {
  root: {
    class: [
      ...
      "[&>[data-pc-name=inputicon]]:text-mercury-900/60 dark:[&>[data-pc-name=inputicon]]:text-white/60",
      ...
      "[&>[data-pc-extend=inputicon]]:text-mercury-900/60 dark:[&>[data-pc-extend=inputicon]]:text-white/60",
