export default {
    root: ({ props, context, parent, instance }) => ({
        class: [
            ...
            // Success Button
            {
                'text-white dark:text-jade-900': props.severity === 'success' && !props.text && !props.outlined && !props.plain,
                'bg-jade-500 dark:bg-jade-400': props.severity === 'success' && !props.text && !props.outlined && !props.plain,
                'border border-jade-500 dark:border-jade-400': props.severity === 'success' && !props.text && !props.outlined && !props.plain
            },
            // Success Text Button
            { 'text-jade-500 dark:text-jade-400': props.text && props.severity === 'success' && !props.plain },
            // Success Outlined Button
            { 'text-jade-500 border border-jade-500 hover:bg-jade-300/10': props.outlined && props.severity === 'success' && !props.plain },

            // Info Button
            {
                'text-white dark:text-surface-900': props.severity === 'info' && !props.text && !props.outlined && !props.plain,
                'bg-primary-500 dark:bg-primary-400': props.severity === 'info' && !props.text && !props.outlined && !props.plain,
                'border border-primary-500 dark:border-primary-400': props.severity === 'info' && !props.text && !props.outlined && !props.plain
            },
            // Info Text Button
            { 'text-primary-500 dark:text-primary-400': props.text && props.severity === 'info' && !props.plain },
            // Info Outlined Button
            { 'text-primary-500 border border-primary-500 hover:bg-primary-300/10 ': props.outlined && props.severity === 'info' && !props.plain },

            // Warning Button
            {
                'text-white dark:text-surface-900': props.severity === 'warn' && !props.text && !props.outlined && !props.plain,
                'bg-sulfur-500 dark:bg-sulfur-400': props.severity === 'warn' && !props.text && !props.outlined && !props.plain,
                'border border-sulfur-500 dark:border-sulfur-400': props.severity === 'warn' && !props.text && !props.outlined && !props.plain
            },
            // Warning Text Button
            { 'text-sulfur-500 dark:text-sulfur-400': props.text && props.severity === 'warn' && !props.plain },
            // Warning Outlined Button
            { 'text-sulfur-500 border border-sulfur-500 hover:bg-sulfur-300/10': props.outlined && props.severity === 'warn' && !props.plain },
            ...
            // Danger Button
            {
                ...
                'bg-ruby-500 dark:bg-ruby-400': props.severity === 'danger' && !props.text && !props.outlined && !props.plain,
                'border border-ruby-500 dark:border-ruby-400': props.severity === 'danger' && !props.text && !props.outlined && !props.plain
            },
            // Danger Text Button
            { 'text-ruby-500 dark:text-ruby-400': props.text && props.severity === 'danger' && !props.plain },
            // Danger Outlined Button
            { 'text-ruby-500 border border-ruby-500 hover:bg-ruby-300/10': props.outlined && props.severity === 'danger' && !props.plain },
            ...
            // Success
            { 'hover:bg-jade-600 dark:hover:bg-jade-300 hover:border-jade-600 dark:hover:border-jade-300': props.severity === 'success' && !props.text && !props.outlined && !props.plain },
            { 'focus:ring-jade-500 dark:focus:ring-jade-400': props.severity === 'success' },
            // Text & Outlined Button
            { 'hover:bg-jade-300/10': (props.text || props.outlined) && props.severity === 'success' && !props.plain },

            // Info
            { 'hover:bg-primary-600 dark:hover:bg-primary-300 hover:border-primary-600 dark:hover:border-primary-300': props.severity === 'info' && !props.text && !props.outlined && !props.plain },
            { 'focus:ring-primary-500 dark:focus:ring-primary-400': props.severity === 'info' },
            // Text & Outlined Button
            { 'hover:bg-primary-300/10': (props.text || props.outlined) && props.severity === 'info' && !props.plain },

            // Warning
            { 'hover:bg-sulfur-600 dark:hover:bg-sulfur-300 hover:border-sulfur-600 dark:hover:border-sulfur-300': props.severity === 'warn' && !props.text && !props.outlined && !props.plain },
            { 'focus:ring-sulfur-500 dark:focus:ring-sulfur-400': props.severity === 'warn' },
            // Text & Outlined Button
            { 'hover:bg-sulfur-300/10': (props.text || props.outlined) && props.severity === 'warn' && !props.plain },
            ...
            // Danger
            { 'hover:bg-ruby-600 dark:hover:bg-ruby-300 hover:border-ruby-600 dark:hover:border-ruby-300': props.severity === 'danger' && !props.text && !props.outlined && !props.plain },
            { 'focus:ring-ruby-500 dark:focus:ring-ruby-400': props.severity === 'danger' },
            // Text & Outlined Button
            { 'hover:bg-ruby-300/10': (props.text || props.outlined) && props.severity === 'danger' && !props.plain },
