export default {
  root: ({ props, context, parent, instance }) => ({
    class: [
      ...
      {
        "text-primary-500 border border-primary-500 hover:bg-primary-300/10 ":
      ...
      // Danger Button
      {
        "text-white dark:text-surface-900":
          ...
          !props.outlined &&
          !props.plain,
        "bg-ruby-500 dark:bg-ruby-400":
          props.severity === "danger" &&
          !props.text &&
          !props.outlined &&
          !props.plain,
        "border border-ruby-500 dark:border-ruby-400":
          props.severity === "danger" &&
          !props.text &&
          !props.outlined &&
          !props.plain,
      ...
      {
        "text-ruby-500 border border-ruby-500 hover:bg-ruby-300/10":
      ...
      // Danger
      {
        "hover:bg-ruby-600 dark:hover:bg-ruby-300 hover:border-ruby-600 dark:hover:border-ruby-300":
          props.severity === "danger" &&
          !props.text &&
          !props.outlined &&
          !props.plain,
      ...
      {
        "focus:ring-ruby-500 dark:focus:ring-ruby-400":
          props.severity === "danger",
      },
      // Text & Outlined Button
      {
        "hover:bg-ruby-300/10":
          (props.text || props.outlined) &&
          props.severity === "danger" &&
          !props.plain,
      },
