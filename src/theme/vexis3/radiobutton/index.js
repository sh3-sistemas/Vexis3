export default {
  ...
  box: ({ props, context }) => ({
    class: [
      ...
      // Colors
      {
        "text-mercury-700 dark:text-white/80": context.checked,
      ...
      // States
      {
        "peer-hover:border-mercury-400 dark:peer-hover:border-mercury-400":
        ...
        "peer-focus-visible:ring-1 peer-focus-visible:ring-primary-500 dark:peer-focus-visible:ring-primary-400":
          !props.disabled,
        "bg-mercury-200 [&>*:first-child]:bg-mercury-600 dark:bg-mercury-700 dark:[&>*:first-child]:bg-mercury-400 border-mercury-300 dark:border-mercury-700 select-none pointer-events-none cursor-default":
          props.disabled,
      },
    ],
  }),
  input: {
    class: [
      ...
      "rounded-md",
      "outline-none",
      "border-1 border-mercury-200 dark:border-mercury-700",
  ...
  icon: ({ context }) => ({
    class: [
      ...
      // Conditions
      {
        "bg-mercury-0 dark:bg-mercury-900": context.checked,
